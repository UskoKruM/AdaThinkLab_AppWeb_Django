# AdaThinkLab_AppWeb_Django
Aplicación web creada con Python y el framework para aplicaciones web Django, durante webinar parte del Hacktoberfest organizado por AdaThinkLab.
